...
-o	Specifies the filename to write found URLs to. The default filename is output.txt	-o <filename>
-read	Reads URLs from stdin instead of a file specified by the -l flag	-read
